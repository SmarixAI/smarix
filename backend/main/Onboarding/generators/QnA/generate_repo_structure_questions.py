...
def generate_repo_structure_questions(
    ...
    repo_structure_file = repo_root / "data" / "Onboarding" / "onboarding_reading_data" / "onboarding_repo_structure.json"
...
if __name__ == "__main__":
    ...
    print(f"  • Focus: Repository Structure for Developer Onboarding\n")
