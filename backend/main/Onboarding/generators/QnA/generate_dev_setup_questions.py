...
def generate_dev_setup_questions(
    ...
    dev_setup_file = repo_root / "data" / "Onboarding" / "onboarding_reading_data" / "onboarding_dev_setup.json"
...
if __name__ == "__main__":
    ...
    print(f"  • Focus: Development Environment Setup for New Developers\n")
