...
def generate_app_features_questions(
    ...
    app_features_file = repo_root / "data" / "Onboarding" / "onboarding_reading_data" / "onboarding_app_features.json"
...
if __name__ == "__main__":
    ...
    print(f"  • Focus: Application Features for User Onboarding\n")
