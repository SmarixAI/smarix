...
def generate_code_conventions_data(db_path, gmail_db_path=None, provider='openai', model=None):
...
if __name__ == "__main__":
    ...
    generate_code_conventions_data(GITHUB_DB_PATH, GMAIL_DB_PATH, PROVIDER, MODEL)
