...
def generate_repo_structure_data(db_path, gmail_db_path=None, provider='openai', model=None):
...
if __name__ == "__main__":
    ...
    generate_repo_structure_data(GITHUB_DB_PATH, GMAIL_DB_PATH, PROVIDER, MODEL)
