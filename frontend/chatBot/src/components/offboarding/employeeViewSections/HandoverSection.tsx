...
export default function EmployeeHandoverSection({
  ...
  if (loading)
    return (
      <Loader
        darkMode={false}
        message="Analyzing handover requirements..."
        size="md"
      />
    );
        ...
        <div className="px-8 py-6 border-b-2 border-slate-200 bg-gradient-to-r from-slate-50 to-blue-50/30 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-slate-600 mt-1 font-medium">
              Critical transitions and asset transfers
            </p>
          </div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          ...
                          {task.estimated_time_minutes && (
                            <>
                              ...
                              <span className="flex items-center gap-1 text-[11px] text-slate-400 font-bold uppercase">
                            ...
                            <ul className="space-y-3">
                              {(
                                task.questions || [
                                  ...
                                  "Share relevant access credentials",
