  ...
  const steps = [
    {
      ...
      desc: "Give new hires instant access to the codebase, architecture, and context they need to contribute quickly.",
    },
    {
      id: "02",
      title: "Offboard smarter",
      desc: "Capture critical context, decisions, and tribal knowledge before it leaves with the employee.",
    },
    {
      id: "03",
      title: "Keep knowledge forever",
      desc: "Build an institutional memory that grows with every hire and every exit.",
    },
  ];
