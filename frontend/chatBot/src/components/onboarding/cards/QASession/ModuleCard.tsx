...
const QAModuleCard = forwardRef<HTMLDivElement, QAModuleCardProps>(
  ({ module, index, darkMode, isVisible, onCardClick }, ref) => {
...
QAModuleCard.displayName = 'QAModuleCard';

export default memo(QAModuleCard, (prevProps, nextProps) => {
  return (
